...
<body>
	...
	%for o in lines(data['form']):
		...
		%endif
		<tr>
			%if o['type'] == 'view' and o['id'] == 0:
			<td style="font-weight: bold; font-size:11px;">${o['code']}</td>
			%elif o['type'] == 'view' and o['level'] != 1:
			<td>${o['code']}</td>
			%elif o['type'] == 'view' and o['level'] == 1:
			<td>${o['code']}</td>
			%endif
			...
			%if o['type'] == 'view' and o['id'] == 0:
			<td style="font-weight: bold; font-size:11px;">${o['name'].upper()}</td>
			%elif o['type'] == 'view' and o['level'] != 1:
			<td>${o['name'].upper()}</td>
			%elif o['type'] == 'view' and o['level'] == 1:
			<td>${o['name'].upper()}</td>
			...
			%if o['type'] == 'view' and o['level'] != 1:
			<td>${to_money(o['balanceinit'])}
			%elif o['id'] == 0:
			<td style="font-weight: bold; font-size:11px;">	${to_money(o['balanceinit'])}
			%endif
			
			%if o['type'] == 'view' and o['level'] != 1:
			<td>${to_money(o['debit'])}</td>
			%elif o['id'] == 0:
			<td style="font-weight: bold; font-size:11px;">	${to_money(o['debit'])}</td>
			%endif
			
			%if o['type'] == 'view' and o['level'] != 1:
			<td>${to_money(o['credit'])}</td>
			%elif o['id'] == 0:
			<td style="font-weight: bold; font-size:11px;">	${to_money(o['credit'])}</td>
			%endif
			
			%if o['type'] == 'view' and o['level'] != 1:
			<td>${to_money(o['ytd'])}</td>
			%elif o['id'] == 0:
			<td style="font-weight: bold; font-size:11px;">	${to_money(o['ytd'])}</td>
			%endif
			
			%if o['type'] == 'view' and o['level'] != 1:
			<td>${to_money(o['balance'])}</td>
			%elif o['id'] == 0:
			<td style="font-weight: bold; font-size:11px;">	${to_money(o['balance'])}</td>
			%endif
