...
class income_statement_wizard(osv.osv_memory):
    _name = "wizard.income.statement"
    ...
    _columns = {
        ...
        'periods': fields.many2many('account.period', 'rel_wizard_period_income_statement', 'wizard_id', 'period_id', 'Periods', help='All periods in the fiscal year if empty'),
